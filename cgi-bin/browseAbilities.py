...
if len(records) > 0:
    ...
    for record in records:
        ...
        print('''<td><form action="viewAbility.py">
                <input type="hidden" name="abilityID" value="'''
                + str(record[0]) + '''">
                <input type=submit name=empty value="">
                </form></td>''')
        print('''<td><form action="editAbility.py">
                <input type="hidden" name="abilityID" value="'''
                + str(record[0]) + '''">
                <input type=submit name=empty value="">
                </form></td>''')
        print('''<td><form action="removeAbility.py">
                <input type="hidden" name="abilityID" value="'''
                + str(record[0]) + '''">
                <input type=submit name=empty value="">
                </form></td>''')
        print('''<td><form action="addAbilityToCharacter.py">
                <input type="hidden" name="abilityID" value="'''
                + str(record[0]) + '''">
                <input type=submit name=empty value="">
                </form></td>''')
