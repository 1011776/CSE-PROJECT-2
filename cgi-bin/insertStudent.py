...
print('<title>D&D Database: Insert a Student</title>')
print('<link rel="stylesheet" href="../stylesheet.css">')

print('<h1>D&D Database</h1>')
print('<h2>Insert a Student</h2>')
...
cursor.execute('''
        INSERT INTO Student(StudentID, FirstName, LastName, Year) 
        VALUES (:studentID, :firstName, :lastName, :year)
        ''', values)
